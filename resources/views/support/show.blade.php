...
<div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-10">
    <div class="grid col-span-3 grid-cols-4 gap-3">
        ...
        <form class="col-span-2" method="POST" action="{{ route('support.close-ticket', $ticket) }}">
            @csrf
            <button @if($ticket->status) disabled @endif type="submit" class="flex items-center justify-center gap-1 focus:outline-none @if($ticket->status) bg-red-300 cursor-not-allowed @else bg-red-700 hover:bg-red-800 @endif text-white focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
    ...
    <div class="d-flex col-span-9 bg-white border border-gray-200 rounded-2xl px-10 py-6">
        ...
        <div class="flex flex-col justify-between gap-3">
            <div class="flex flex-col gap-1">
                <span class="font-bold text-l">عناون: </span>
